...
class SemiAutoAllNumberLotteryScreen extends StatefulWidget {
  const SemiAutoAllNumberLotteryScreen({Key? key}) : super(key: key);

  @override
  State<SemiAutoAllNumberLotteryScreen> createState() =>
      _SemiAutoAllNumberLotteryScreenState();
}

class _SemiAutoAllNumberLotteryScreenState
    extends State<SemiAutoAllNumberLotteryScreen> {
