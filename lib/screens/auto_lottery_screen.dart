...
import 'package:for_prize/screens/auto_all_number_by_section_screen.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            FunctionGuideWidget(functionName: "선택한 숫자 중 추첨", page: AutoSelectNumberLotteryScreen()),
            FunctionGuideWidget(functionName: "각 구간별 개수 선택 후 추첨", page: AutoAllNumberBySectionScreen()),
